    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <footer className="mt-12 pt-6 border-t border-gray-200 text-sm text-gray-600">
          <p className="mb-2">
            Viimeksi päivitetty: 1.12.2025 • Siivousote / Y-tunnus 2166541–5 • <a href="https://www.siivousote.fi" className="text-[#847866] hover:underline">www.siivousote.fi</a>
          </p>
          ...
          <>
            ...
            <footer className="mt-12 pt-6 border-t border-gray-200 text-sm text-gray-600">
              <p className="mb-2">
                Last updated: 1.12.2025 • Siivousote / Business ID 2166541–5 • <a href="https://www.siivousote.fi" className="text-[#847866] hover:underline">www.siivousote.fi</a>
              </p>
