          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                <div
                  className="bg-gradient-to-br from-[#003580] to-[#0047ab] w-14 h-14 rounded-xl flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300 shadow-lg"
