...
export default function CustomQuote() {
  ...
  return (
    <section className="section-container section-padding">
      <div className="relative bg-white/6 rounded-2xl text-[#1f2937] text-center overflow-hidden" style={{ padding: '3rem 2rem' }}>
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-10 right-10 w-48 h-48 bg-white rounded-full blur-3xl"></div>
          <div className="absolute bottom-10 left-10 w-64 h-64 bg-gray-300 rounded-full blur-3xl"></div>
        </div>
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center" style={{ gap: '1rem' }}>
            <Link href="/order" className="inline-block bg-white text-[#1f2937] rounded-full px-6 py-3 font-semibold shadow-md">
