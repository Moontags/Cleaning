...
export default function Hero({
  ...
  const config = {
    ...
    service: {
      ...
      titleClass: `text-5xl md:text-6xl font-bold leading-tight ${
        titleClassName || ""
      }`,
      subtitleClass: `text-xl text-blue-100 leading-relaxed ${
        subtitleClassName || ""
      }`,
      showAnimation: false,
      decorativeCircles: {
      ...
      paddingInline: { paddingTop: "6rem", paddingBottom: "6rem" },
    },
    simple: {
  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={`section-container ${config.padding} relative z-10`}
          style={variant === "service" ? config.paddingInline : undefined}
        >
          <div
