...
const translations = {
    ...
    "service.floor.equipment.title": "Huolellinen pesu, siisti lopputulos",
    "service.floor.equipment.alt": "Kärcher K-Mop 46 Bp Pack -yhdistelmäkone lattioiden koneelliseen pesuun",
    "service.floor.equipment.detail1.alt": "K-Mop-yhdistelmäkoneen rungon ja varren yksityiskohta",
    "service.floor.equipment.detail2.alt": "K-Mop-yhdistelmäkoneen ohjauskahva ja käyttöpaneeli",
    "service.floor.equipment.detail3.alt": "K-Mop-yhdistelmäkoneen säiliö ja letkuliitäntä",
    ...
    "home.floor.eyebrow": "Koneellinen lattianpesu toimitiloihin",
    "home.floor.title": "Puhtaat lattiat. Huoliteltu ensivaikutelma.",
    "home.floor.description": "Huolellinen konepesu toimistojen, myymälöiden ja muiden toimitilojen koville, pesunkestäville lattioille. Valitsemme menetelmän lattiasi materiaalin ja kunnon mukaan.",
    "home.floor.explore": "Tutustu konepesuun",
    "home.floor.caption": "Huolellista puhdistusta lattian ehdoilla",
    "home.services.heading": "Siivouspalvelut tilasi tarpeisiin",
    "home.services.intro": "Konepesusta säännölliseen siivoukseen – tutustu palveluihimme ja löydä tilallesi sopiva ratkaisu.",
    "home.services.more": "Tutustu palveluun",
    "service.floor.care.title": "Lattianhoito tilasi tarpeisiin",
    "service.floor.care.intro": "Pesuväli ja käsittely valitaan käytön, likaantumisen ja lattian valmistajan hoito-ohjeen mukaan.",
    "service.floor.frequency.title": "Kuinka usein konepesu kannattaa tehdä?",
    "service.floor.frequency.busy": "Vilkkaat myymälät, sisäänkäynnit ja muut paljon käytetyt tilat: konepesu voi olla tarpeen päivittäin tai viikoittain osana ylläpitosiivousta.",
    "service.floor.frequency.quiet": "Rauhallisemmat toimistot ja toimitilat: konepesu sovitaan tarpeen mukaan tavallisen ylläpitosiivouksen tueksi. Sesongit ja ulkoa kulkeutuva lika voivat tihentää pesuväliä.",
    "service.floor.frequency.deep": "Perusteellisempi pesu on ajankohtainen, kun tavallinen siivous ei enää irrota pinttynyttä likaa. Arvioimme tarpeen lattian kunnon perusteella, emme pelkän kalenterin mukaan.",
    "service.floor.materials.title": "Mille lattioille palvelu sopii?",
    "service.floor.materials.wash": "Kovat, pesunkestävät pinnat, kuten keraaminen laatta sekä konepesuun soveltuvat muovi- ja vinyylilattiat. Myös ehjät, pesunkestävät pinnoitetut betonilattiat arvioidaan kohdekohtaisesti.",
    "service.floor.materials.check": "Linoleumi, kumi ja luonnonkivi vaativat materiaalille sopivat aineet ja välineet. Tarkistamme myös pintakäsittelyn ja saumojen kunnon.",
    "service.floor.materials.exclude": "Parketti, puu, laminaatti ja tekstiililattiat eivät kuulu tähän kovien lattioiden konepesupalveluun. Niille valitaan erillinen, valmistajan hyväksymä puhdistusmenetelmä.",
    "service.floor.wax.title": "Vahaus ja vanhan vahan poisto",
    "service.floor.wax.polish": "Vahaus suojaa vahattavaksi tarkoitettua lattiaa. Se voi soveltua esimerkiksi osalle muovi- ja linoleumilattioista, jos valmistajan hoito-ohje sallii sen. Tehdaspinnoitettu lattia ei välttämättä tarvitse vahaa.",
    "service.floor.wax.strip": "Vanhan vahan poiston tarve arvioidaan, kun vahapinta on laajasti kulunut tai likaa on kerrostunut. Paikalliseen kulumiseen voi riittää pintapesu ja paikkavahaus.",
    "service.floor.wax.quote": "Vahauksen ja vahanpoiston hinta sekä työ- ja kuivumisaika arvioidaan erikseen pinta-alan, vanhojen vahakerrosten, lattian kunnon ja kalusteiden siirron tarpeen perusteella. Työt eivät sisälly konepesun alkaen-hintaan.",
    ...
    "pricing.window_cleaning_info":
      "* Ikkunan pesu 50€/h minimiveloitus 2 tuntia!",
    ...
    "about.story.p1":
      "Olemme kotimainen siivousyritys, jonka tiimillä on jo pitkä ja monipuolinen kokemus siivousalalta.",
    "about.story.p2a":
      "Tiimimme koostuu koulutetuista ammattilaisista, jotka ovat vuosien varrella hankkineet laajan osaamisen ja ovat sitoutuneet tarjoamaan korkeinta laatua jokaisessa työkohteessa.",
    "about.story.p2b":
  ...
  en: {
    ...
    "service.floor.equipment.title": "Careful cleaning, a clean finish",
    "service.floor.equipment.alt": "Kärcher K-Mop 46 Bp Pack scrubber dryer for machine floor cleaning",
    "service.floor.equipment.detail1.alt": "Detail of the K-Mop scrubber dryer body and shaft",
    "service.floor.equipment.detail2.alt": "K-Mop scrubber dryer handle and control panel",
    "service.floor.equipment.detail3.alt": "K-Mop scrubber dryer tank and hose connection",
    ...
    "home.floor.eyebrow": "Machine floor cleaning for your premises",
    "home.floor.title": "Clean floors. A polished first impression.",
    "home.floor.description": "Careful machine cleaning for hard, washable floors in offices, shops and other business premises. We select the method to suit your floor’s material and condition.",
    "home.floor.explore": "Explore floor cleaning",
    "home.floor.caption": "Careful cleaning tailored to your floor",
    "home.services.heading": "Cleaning services for your premises",
    "home.services.intro": "From machine floor cleaning to regular cleaning – explore our services and find the right solution for your space.",
    "home.services.more": "Explore the service",
    "service.floor.care.title": "Floor care tailored to your premises",
    "service.floor.care.intro": "Cleaning frequency and treatment depend on use, soiling and the flooring manufacturer’s care instructions.",
    "service.floor.frequency.title": "How often should floors be machine cleaned?",
    "service.floor.frequency.busy": "Busy shops, entrances and other high-traffic areas may need machine cleaning daily or weekly as part of routine cleaning.",
    "service.floor.frequency.quiet": "Quieter offices and premises: machine cleaning is scheduled as needed alongside routine cleaning. Seasonal conditions and dirt brought in from outside may require more frequent cleaning.",
    "service.floor.frequency.deep": "More thorough cleaning is due when routine cleaning no longer removes ingrained dirt. We assess the floor’s condition rather than follow a fixed calendar.",
    "service.floor.materials.title": "Which floors is the service suitable for?",
    "service.floor.materials.wash": "Hard, washable surfaces such as ceramic tiles and plastic or vinyl flooring approved for machine cleaning. Sound, washable coated concrete floors are also assessed individually.",
    "service.floor.materials.check": "Linoleum, rubber and natural stone require suitable cleaning agents and equipment. We also check the surface finish and the condition of joints.",
    "service.floor.materials.exclude": "Parquet, wood, laminate and textile flooring are outside this hard-floor machine cleaning service. They require a separate cleaning method approved by the manufacturer.",
    "service.floor.wax.title": "Floor waxing and old wax removal",
    "service.floor.wax.polish": "Waxing protects floors designed for this treatment. It may suit some plastic and linoleum floors if permitted by the manufacturer’s care instructions. Factory-finished flooring may not need wax.",
    "service.floor.wax.strip": "Old wax removal is assessed when the finish is extensively worn or dirt has built up. Localised wear may only require surface cleaning and spot waxing.",
    "service.floor.wax.quote": "Waxing and wax removal prices, working time and drying time are assessed separately based on floor area, old wax layers, floor condition and any furniture moving needed. These treatments are not included in the starting price for machine cleaning.",
    ...
    "pricing.window_cleaning_info":
      "* Window cleaning 50€/h, minimum charge 2 hours!",
    ...
    "about.story.p1":
      "We are a Finnish cleaning company, and our team already has long and versatile experience in the cleaning industry.",
    "about.story.p2a":
      "Our team consists of trained professionals who have acquired extensive expertise over the years and are committed to providing the highest quality in every work assignment.",
    "about.story.p2b":
